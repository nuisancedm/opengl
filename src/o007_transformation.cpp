...
int main()
{
    ...
    std::cout << "[MESSAGE]: executable launched from file 007" << std::endl;
...

    {
        ...
        Shader shader("../src/shader/o007.shader");
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            trans = glm::rotate(trans, glm::radians(degreeX), glm::vec3(1.0, 0.0, 0.0));
            trans = glm::rotate(trans, glm::radians(degreeY), glm::vec3(0.0, 1.0, 0.0));
            trans = glm::rotate(trans, glm::radians(degreeZ), glm::vec3(0.0, 0.0, 1.0));
            ...
            ImGui::NewFrame();
            {
                ...
                ImGui::SliderFloat("degreeX", &degreeX, 0.0f, 360.0f);                                 // Edit 1 float using a slider from 0.0f to 1.0f
                ImGui::SliderFloat("degreeY", &degreeY, 0.0f, 360.0f);                                 // Edit 1 float using a slider from 0.0f to 1.0f
                ImGui::SliderFloat("degreeZ", &degreeZ, 0.0f, 360.0f);                                 // Edit 1 float using a slider from 0.0f to 1.0f
                ImGui::End();
            }
            ImGui::Render();
